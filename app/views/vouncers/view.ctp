<div class="vouncers view">
<h2><?php  __('Vouncer');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $vouncer['Vouncer']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('User'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($vouncer['User']['name'], array('controller' => 'users', 'action' => 'view', $vouncer['User']['id'])); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $vouncer['Vouncer']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('Edit %s', true), __('Vouncer', true)), array('action' => 'edit', $vouncer['Vouncer']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Delete %s', true), __('Vouncer', true)), array('action' => 'delete', $vouncer['Vouncer']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $vouncer['Vouncer']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('List %s', true), __('Vouncers', true)), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($vouncer['Record'] as $record):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}

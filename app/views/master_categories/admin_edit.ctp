...
<?php echo $this->Form->create('MasterCategory');?>
	<fieldset>
 		<legend><?php printf(__('Admin Edit %s', true), __('Master Category', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MasterCategory.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MasterCategory.id'))); ?></li>

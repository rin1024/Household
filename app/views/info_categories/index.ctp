<div class="infoCategories index">
	<h2><?php __('Info Categories');?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id');?></th>
			<th><?php echo $this->Paginator->sort('user_id');?></th>
			<th><?php echo $this->Paginator->sort('master_category_id');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $infoCategory['InfoCategory']['id']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($infoCategory['User']['name'], array('controller' => 'users', 'action' => 'view', $infoCategory['User']['id'])); ?>
		</td>
		<td>
		...
		<td><?php echo $infoCategory['InfoCategory']['name']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $infoCategory['InfoCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $infoCategory['InfoCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $infoCategory['InfoCategory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $infoCategory['InfoCategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
